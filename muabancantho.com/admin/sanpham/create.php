            ...
            <div class="col-8">
                ...
                <form name="frmCreate" method="post" action="">
                    ...
                    <div>
                        ...
                        <textarea id="sp_mota_chitiet" name="sp_mota_chitiet" class="form-control"></textarea>
                    </div>
                    <div>
                ...
                if(isset($_POST['btnSave'])) {
                    ...
                    // 2. Chuẩn bị câu lệnh
                    $sqlInsertSanPham = "INSERT INTO sanpham
                                        (sp_ten, sp_gia, sp_giacu, sp_mota_ngan, sp_mota_chitiet, sp_ngaycapnhat, sp_soluong, lsp_ma, nsx_ma, km_ma)
                                        VALUES ('$sp_ten', $sp_gia, NULL, '$sp_mota_ngan', '$sp_mota_chitiet', '$sp_ngaycapnhat', $sp_soluong, $lsp_ma, $nsx_ma, $km_ma);";
                    // var_dump($sqlInsertSanPham);
                    // 3. Thực thi
                    mysqli_query($conn, $sqlInsertSanPham);
                    // 4. Xong, điều hướng vể trang danh sách
                    // 4.1. Lưu câu thông báo trong session
                    $_SESSION['flash_msg'] = "Đã thêm sản phẩm <b>[$sp_ten]</b> thành công!";
